        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <div>
                <p className="font-bold text-sm">{t('site_title')}</p>
                <p className="text-xs text-background/70">{t('site_subtitle')}</p>
              </div>
            </div>
            <p className="text-sm text-background/70 font-hindi leading-relaxed">
              {t('footer_address_hindi')}
            </p>
          </div>

          {/* ── Quick links column ── */}
          <nav aria-label="Footer quick links">
            <h2 className="font-bold text-sm mb-4 text-gold">{t('quick_links')}</h2>
          ...
          {/* ── Contact column ── */}
          <div>
            <h2 className="font-bold text-sm mb-4 text-gold">{t('contact')}</h2>
