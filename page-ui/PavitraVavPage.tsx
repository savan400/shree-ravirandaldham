                        ...
                        <div className={`${styles.textCol} ${visible ? styles.visible : ""}`}>
                            <div className={styles.contentCard}>
                                ...
                                <p className={styles.contentText}>
                                    આ એક ઐતિહાસિક વાવ છે. અહીંથી રાણાલ નદીનું પાણી નીકળતું હતું, અને પછીથી, તેને પગથિયાં ("વાવ ના દડવા" તરીકે ઓળખવામાં આવે છે) દ્વારા ઓળખવામાં આવે છે!
                                </p>
                                <RandalSahayate />
                            </div>
                        </div>
