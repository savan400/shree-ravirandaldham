          ...
          <div className={visibleClass("content", visible)}>
            <div className={styles.contentIntro}>
              <p className={styles.introText}>
                અનંત જીવોનાં કલ્યાણ કરવાનાં ભગવાન શ્રી સ્વામિનારાયણનાં સંકલ્પને
                સિદ્ધ કરવા અનેક મુકતાઓએ જન્મ ધારણ કર્યો હતો.
              </p>
              <p className={styles.introText}>
                પાંચસો પરમહંસોમાં સૂર્યની જેમ ચમકતા યોગીરાજ ગોપાળાનંદ સ્વામીમાં
                જન્મસિદ્ધ યોગકળા હતી. અનેક ઐશ્વર્ય અને સામર્થ્યનાં સ્વામી હોવા
                છતાં ભગવાન પ્રત્યે દાસભાવપણે અને તેમની આજ્ઞાવી આળખ હતી.
              </p>
            </div>
              ...
              <div className={styles.contentSection}>
                ...
                <div className={styles.sectionText}>
                  <p>
                    ...
                    તેમનો જન્મ થયો અને બાળપણનું નામ શંખવામાં આવ્યું – ખુશાલ. ગૌર
                    વર્ણ અને તેજસ્વી મુખમુક્તિ ધરાવતાં આ બાળકનાં જન્મજાત લક્ષણો
                    પ્રચલિત દિરણો ફૂટે તેમ એક પછી એક પ્રકાશવા લાગ્યાં.
                  </p>
                  <p>
                    પૂર્વનાં યોગાભ્યાસી ખુશાલ સદાય ટોડરા ગામનાં પાદરે વહેતી
                    નદીનાં કિનારે આવેલાં મહાદેવનાં દેશ પાસે ધ્યાનમગ્ન બેસી
                    રહેતાં. તો કયારેક સોસામાણી પર્વતમાળાનો કેદરામાં જઈને તપ
                    કરતાં. ભક્તિ અને યોગની કાંતિ તેમનાં મુખમંડિત ઉપર સહેજ
                    કરવાતી.
                  </p>
                  <p>
                    અસાધારણ બુદ્ધિપ્રતિભા ધરાવતાં ખુશાલ ભટ્ટ શિક્ષા ગ્રહણ પછી
                    ટોડરા ગામમાં પાઠશાળા શરૂ કરી. અહીં તેઓ બાળકોને જ્ઞાન
                    પહંચાનાં સાથે ભગવદ્ભક્તિનાં પાઠો પણ ભણાવતાં. ધુન, કીર્તન,
                    શાસ્ત્રમાં નિત્યનિમિત ભગવાનનાં ચરિત્રોનું અધ્યયન પણ કરાવતાં.
                  </p>
                </div>
              </div>
            </div>
