                ...
                <div className={visibleClass("header", visible)}>
                    ...
                    <div className={cu.cuWrap}>
                                ...
                                <div className={cu.cuInfoRow}>
                                    ...
                                    <div>
                                        ...
                                        <p className={cu.cuInfoValue}>
                                            Ravi, near Dadva Road, near vasavad, Ravi Randal Na, Randal Na Dadava, Dadva, Gujarat 365460
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className={cu.cuInfoCard}>
                                <div className={cu.cuInfoRow}>
                                    ...
                                    <div>
                                        ...
                                        <p className={cu.cuInfoValue}>
                                            <a href="mailto:shreesalangpur@gmail.com">shreesalangpur@gmail.com</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className={cu.cuFormWrap}>
                            <h3 className={cu.cuFormTitle}>Send Us a Message</h3>
                            <p className={cu.cuFormSub}>We'd love to hear from you</p>
                            <div className={cu.cuFormDivider} />

                            <form onSubmit={handleSubmit} autoComplete="off">
                                <div className={cu.cuField}>
                                    <span className={cu.cuFieldIcon}>👤</span>
                                    <input
                                        type="text"
                                        name="name"
                                ...
                                <div className={cu.cuField}>
                                    <span className={cu.cuFieldIcon}>✉️</span>
                                    <input
                                        type="email"
                                        name="email"
                                ...
                                <button type="submit" className={cu.cuSubmit}>
                                    <span className={cu.cuSubmitShine} />
                                    🪔 Send Message
                                </button>

                                {sent && (
                                    <div className={cu.cuSuccess}>
                                        ✦ Your message has been received. Jai Swaminarayan! ✦
                                    </div>
                                )}
                            </form>
                        </div>
                    ...
                    {/* ── Google Map ── */}
                    <div className={cu.cuMapSection}>
                        <h3 className={cu.cuMapHeading}>Find Us</h3>
                        <p className={cu.cuMapSub}>Salangpur Dham — Kashtabhanjan Dev Mandir</p>

                        <div className={cu.cuMapFrameWrap}>
