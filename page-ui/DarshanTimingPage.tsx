...
const DarshanTimingPage = () => {
  ...
  const darshanTimings = [
    {
      label: "મંગળા આરતી",
      time: "સવારે 06:15 કલાકે",
    },

    {
      label: "થાળ",
      time: "બપોરે 11:00 કલાક",
    },
            ...
            >
              <div className={dStyles.templeImageWrapper}>
                <div className={dStyles.templeImageCard}>
                  <div
                    className={`${dStyles.cornerOrnament} ${dStyles.cornerTl}`}
                  />
                  <div
                    className={`${dStyles.cornerOrnament} ${dStyles.cornerTr}`}
                  />
                  <div
                    className={`${dStyles.cornerOrnament} ${dStyles.cornerBl}`}
                  />
                  <div
                    className={`${dStyles.cornerOrnament} ${dStyles.cornerBr}`}
                  />
                  <Image
                    src="/images/banner-2.webp"
                    alt="શ્રી કષ્ટભંજન હનુમાનજી દાદા"
